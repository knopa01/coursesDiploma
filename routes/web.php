...
Route::get('/home/edit-content/submit', [CourseContentController::class, 'delete_content'])->middleware(['auth'])->name('delete_content');
...
Route::get('/home/delete-test/submit', [CourseContentController::class, 'delete_test'])->middleware(['auth'])->name('delete_test');
